...
public class MagnatiPosIntegrationLibraryModule extends ReactContextBaseJavaModule {
  ...
  @ReactMethod
  public void getAuthorization(Integer amount,String tid,String receiptNo,Integer timeoutInSec, Promise promise) throws Exception {
  ...
  @ReactMethod
  public void getTIDMID(Integer timeoutInSec,Promise promise) throws Exception {
    final Duration timeout = Duration.ofSeconds(timeoutInSec);
